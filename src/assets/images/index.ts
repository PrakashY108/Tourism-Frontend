export const Images = {
  ...
  icons: {
    ...
    account_fill: require('../images/icons/account_fill.png'),
    right_arrow: require('../images/icons/right-arrow.png'),
    delete: require('../images/icons/delete.png'),
    agreement: require('../images/icons/agreement.png'),
...
export const Dummy = {
  userDummy: require('../Dummy/image.png'),
}
